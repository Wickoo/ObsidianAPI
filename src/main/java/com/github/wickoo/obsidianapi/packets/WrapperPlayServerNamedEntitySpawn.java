...
public class WrapperPlayServerNamedEntitySpawn extends AbstractPacket {
    ...
    public WrapperPlayServerNamedEntitySpawn setDefaults (Player player) {

        if (Utils.getMinecraftVersion().contains("1.8.8")) {

            setYLegacy(player.getLocation().getY());
            setXLegacy(player.getLocation().getX());
            setZLegacy(player.getLocation().getZ());
     ...
     * @param value - new value.
     */
    public void setXLegacy(double value) {
     ...
     * @param value - new value.
     */
    public void setYLegacy(double value) {
     ...
     * @param value - new value.
     */
    public void setZLegacy(double value) {
